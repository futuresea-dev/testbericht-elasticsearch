...
limit_count = None
new_index = "primary_keywords"
old_index = "secondary_keywords"
...
def main():
    ...
    helpers.bulk(es_object, keywords, index=ind_name)
    ...
    print("Imported Records:", len(keywords))

    add_alias(option='keywords', add_index=ind_name)
